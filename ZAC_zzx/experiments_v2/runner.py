...
def _apply_metrics(manifest: RunManifest, metrics: Mapping[str, Any]) -> None:
    aliases = {
        ...
        "python_marshal_ns": "python_marshal_ns",
        "native_call_wall_ns": "native_call_wall_ns",
        ...
        "normalize_ns": "normalize_ns", "decode_ns": "decode_ns",
        "return_match_ns": "return_match_ns",
        "forecast_ns": "forecast_ns", "selection_ns": "selection_ns",
...
def run_attempt(spec: AttemptSpec, *, verifier: Optional[Verifier] = None,
    ...
    if timing_path.is_file():
        try:
            ...
            for key in (
                    "transition_decision_ns", "search_kernel_ns",
                    "problem_preparation_ns", "result_commit_ns", "marshal_ns",
                    "python_marshal_ns", "native_call_wall_ns",
                    "native_search_wall_ns", "fitness_ns", "normalize_ns",
                    "decode_ns", "return_match_ns", "forecast_ns",
                    "selection_ns", "native_parse_ns", "native_serialize_ns",
