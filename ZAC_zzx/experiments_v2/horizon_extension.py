...
# This relocated default does not amend the sealed v1 protocol or its driver
# hash. Resuming that interrupted study requires a newly sealed version.
SOURCE = REPO / "IEEE_conference_template/build/horizon_extension_v1/frozen_source"
