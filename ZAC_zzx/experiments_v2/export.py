...
TABLE_COLUMNS: Mapping[str, tuple[str, ...]] = {
    ...
    "timing_circuits": (
        ...
        "runtime_observed", "median_success_seconds",
        "transition_decision_seconds_median",
        "transition_decision_seconds_q1", "transition_decision_seconds_q3",
        "transition_decision_seconds_iqr", "full_compile_seconds_median",
        "PAR2_seconds",
    ),
    "attempts": (
        ...
        "transition_decision_seconds", "search_kernel_seconds",
        "marshal_seconds", "fitness_seconds", "native_parse_seconds",
        "native_serialize_seconds", "initial_placement_seconds", "routing_seconds",
        "full_compile_seconds", "layer_ledger_sha256", "transition_count",
