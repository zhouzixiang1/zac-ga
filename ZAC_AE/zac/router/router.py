...
class Router_mixin:
    ...
    def write_initial_instruction(self):
        ...
        if len(result_gate) > 0:
            ...
            self.result_json['instructions'][-1]["end_time"] = (self.architecture.time_raman * len(result_gate)) # due to sequential execution
            ...
            if i == 0:
                ...
                for gate_layer_idx in list_gate_layer_idx:    
                    ...
                    if inst["type"] == "rydberg":
                        ...
                        end_time = begin_time + (self.architecture.time_raman * len(inst["gates"])) + self.common_1q # for sequential gate execution
                    if self.result_json["runtime"] < end_time:
                        self.result_json["runtime"] = end_time
                    inst["begin_time"] = begin_time
                    inst["end_time"] = end_time
